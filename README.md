...
- **6.3** Integration — [6.3](./docs/roadmap/sprint-6.3-commitments-integration.md) ✓ (*Financial Timeline* reserved)  
- **6.4+** API → dashboard UI → Nuxt — [sprint brief](./docs/roadmap/sprint-6-financial-commitments.md)
