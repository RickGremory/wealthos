...
Epics group weeks of work under an accepted RFC (or product initiative).
...
| Epic | Title | Parent | Status |
|------|-------|--------|--------|
| [EPIC-001](./EPIC-001-backend-bootstrap.md) | Backend Bootstrap | [RFC-001](../rfc/RFC-001-backend-foundation.md) | Planned |
...
| [EPIC-007](./EPIC-007-planning-safe-to-spend.md) | Planning & Safe To Spend | [RFC-004](../rfc/RFC-004-planning-projection.md) | Done |
| [EPIC-008](./EPIC-008-recurring-engine.md) | Recurring Engine | [RFC-005](../rfc/RFC-005-recurring-engine.md) | In progress |
