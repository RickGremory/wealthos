...
**Status:** Design in progress (9.1 Accepted)  
...
| Slice | Focus | Status |
|-------|--------|--------|
| **9.1** | Domain model (rule, occurrence, exceptions, keys) | **Accepted** — [9.1](./sprint-9.1-recurring-domain-model.md) · [RFC-005](../rfc/RFC-005-recurring-engine.md) |
| **9.2** | Generation engine (daily / weekly / monthly / yearly) | Planned |
...
Day-to-day coding will follow a SPEC once 9.5 opens. Do not reopen 9.1 for algorithm details — that is **9.2**.
